...
# ── Sub-recipes (напівфабрикати) ────────────────────────────

@app.get('/recipes/sub', response_class=HTMLResponse)
...
@app.post('/recipes/sub/{sub_id}/add')
...
@app.post('/recipes/sub/{sub_id}/delete/{item_id}')
